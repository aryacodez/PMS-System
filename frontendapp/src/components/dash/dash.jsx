    ...
    const series1 = [
        {
            ...
            data: Object.keys(protaskcount).map((key) => protaskcount[key].taskSize)||null
        },
    ];
                ...
                <div class="row gx-5">
                    <div class="col">
                        <div class="p-5 bg-white shadow-sm d-flex justify-content-start align-items-start rounded" id='inner-main'>
                            <div>
                                <p className='fs-4 pb-2 px-2 pt-1 mx-4 fw-bolder'>Total Projects</p>
                    ...
                    <div className='col'>
                        <div class="p-5 bg-white shadow-sm d-flex justify-content-start align-items-start rounded" id='inner-main'>
                            <div className='pb-xxl-4'>
                                <h3 className='fs-4 fw-bolder text-start'>Project's Task Count</h3>
                                <Chart
                                    options={option1}
                                    series={series1}
                                    type='bar'
